...
export default function SearchOfTeacher({ navigation,route }) {
        ...
        <ScrollView style={styles.container}>
                        ...
                        <View style={styles.section}>
                            ...
                            {filteredCourses.length > 0 ? (
                                filteredCourses.map(course => (
                                    <TouchableOpacity key={course._id} style={styles.courseItem} onPress={()=>{navigation.navigate("CourseDetailTeacher",{courseID:course._id})}}>
            ...
            <View style={styles.recommendedContainer}>
            {
                    dataCourses.slice(2,4).map((course,index) => (
                        <TouchableOpacity style={styles.courseItem} key={index} onPress={()=>{navigation.navigate("CourseDetailTeacher",{courseID:course._id})}}>             
